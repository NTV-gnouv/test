...
import it.unito.prog.server.session.commands.oauth.LoginCmd;
import it.unito.prog.server.session.commands.oauth.RegisterCmd;
...
public final class CommandManager {
    ...
    private void initOAuthCmds() {
        commands.put(Command.LOGIN, LoginCmd.class);
        commands.put(Command.REGISTER, RegisterCmd.class);
    }
